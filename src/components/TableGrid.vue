  ...
  <div> 
    <b-container fluid>
        ...
        <b-button 
            ...
            id="un"
			block href="#" 
			v-b-toggle=typeGrid.toString() 
			variant="primary"
            style="background-color:Teal">
            Activité {{typeGrid}}
        </b-button>
      </b-card-header>
      <b-collapse v-bind:id=typeGrid.toString() class="mt-2">
        ...
        <envoieMessage :idBouton = typeGrid.toString() :msgBouton = "'Signaler Activité ' + typeGrid"></envoieMessage>
